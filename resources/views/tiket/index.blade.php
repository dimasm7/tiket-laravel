        ...
        <div class="col-md-12">
            <div class="card">
               <div class="card-header"><i class="fas fa-database"> Data Tiket </i></div>
                  <div class="card-body">
                 <a href="{{ route('tiket.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"> Tambah Tiket </i></a>
                   <hr>
                   @include('notifikasi')
                        ...
                        <tbody>
                            ...
                            @foreach ($tiket as $item)
                              <tr>
                                    ...
                                    <td><a href="{{ route('tiket.edit',$item->id) }}"  name="submit" class="btn btn-primary btn-sm">Edit</a></td>
