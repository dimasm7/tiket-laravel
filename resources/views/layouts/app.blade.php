...
<head>
   ...
   <link rel="dns-prefetch" href="https://fonts.gstatic.com">
    ...
    <!-- link utk menyambungkan ke icon yg <i class="fa fa-...."></i>-->
...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <i class="fas fa-assistive-listening-systems"> Sistem Penjualan Tiket</i>
                </a>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.15/jquery.mask.js"></script> <!--untuk format rupiah-->
    <!-- DataTables -->
    ...
    <!-- App scripts -->
    @stack('scripts')
   @yield('chart') <!-- utk koneksi ke grafik -->
</body>
</html>